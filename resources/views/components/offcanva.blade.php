    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body text-arancio bg-nero">
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                    <p class="fw-bold">{{__('ui.ben')}} {{Auth::user()->name}}</p>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link position-relative link-underline link-underline-opacity-0 text-bianco" href="#">{{__('ui.prof')}}</a>
                </li>
                
                @if (Auth::user()->is_revisor)
                
                <li class="nav-item">
                    <a class="nav-link position-relative link-underline link-underline-opacity-0 text-bianco" href="{{route('revisor_index')}}">{{__('ui.area-rev')}}<span class="position-absolute top-0 badge rounded-pill bg-arancio">{{App\Models\Announcement::toBeRevisionedCount()}}<span class="visually-hidden">unread messages</span></span></a>
                </li>
                ...
                <li class="nav-item">
                    <p class="fw-bold">{{__('ui.ospite')}}</p>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link position-relative link-underline link-underline-opacity-0 text-bianco" href="{{route('register')}}">{{__('ui.log-io')}}</a>
                </li>
                @endauth
            </ul>
