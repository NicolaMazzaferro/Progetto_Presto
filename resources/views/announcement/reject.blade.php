<x-layout>
    ...
    <div class=" revisor container p-5">
        ...
        @endif
        {{-- <h1 class="pb-5 text-center">{{$announcement_reject ? "Non ci sono annunci da revisionare":"Ecco l'annuncio da revisionare"}}</h1> --}}
            ...
            <div class="col-12 col-md-4">
                <div class="card my-5">
                        ...
                        <div class="carousel-inner h-25">
                            ...
                            <div class="carousel-item @if ($loop->first)active @endif">
                                ...
                                <div class="row">
                                    ...
                                    <button type="button" class="btn btn-warning fs-6 m-2" data-bs-toggle="modal" data-bs-target="#exampleModal_{{$item->id}}_{{$index}}">
                                        {{__('ui.rave')}}
                                    </button>
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModal_{{$item->id}}_{{$index}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="card-body mt-4">
                        ...
                        <p class="card-text text-tronco">{{$item->description}}</p>
                        <p class="card-text ms-2 mt-5 fw-bolder bg-bianco w-25 border border-warning border-2 p-2 rounded-3">€ {{$item->price}}</p>
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-12 col-md-6">
                            <form action="{{route('announcement_show', ['announcement' => $item])}}" method="get">
                                @csrf
                                @method('get')
                    ...
                    <p class="card-footer fw-bolder fs-6 m-0">{{__('ui.pubblicato')}} {{$item->created_at->format('d/m/Y')}} da {{$item->user->name}}</p>
                </div>
